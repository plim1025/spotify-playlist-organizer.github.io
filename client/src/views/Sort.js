...
const Sort = props => {
    ...
    useEffect(() => {
        if (sortedBy) {
            setSongFilters({
                ...songFilters,
                sort: { category: sortedBy, direction: sortDirection },
            });
        }
    ...
    return (
        <div className={css(ss.wrapper)}>
            <div
                ...
                className={css(ss.toggleIcon)}>
                <svg height='16' width='16' viewBox='0 0 383.947 383.947'>
                    {' '}
            ...
            <div
                style={{
                    background: props.checkmark ? '#606060' : null,
                    border: props.checkmark ? '2px solid #606060' : null,
                }}
                className={css(ss.checkmark)}
                onClick={() => props.handleSelectAll(!props.checkmark)}>
                <svg
                    style={{ fill: props.checkmark ? '#fff' : 'transparent' }}
            ...
            <CategoryMenu
                ...
                handleSetCheckedCategories={props.handleSetCheckedCategories}
            />
        </div>
    );
};
