        ...
        <div className={css(ss.wrapper)}>
            ...
            <div className={css(ss.buttons)}>
                <Button
                    ...
                    onClickHandler={() =>
                        window.open(
                            `https://open.spotify.com/playlist/${query.get(
                                'id'
                            )}`
                        )
                    }
                ...
                <Button
                    ...
                    onClickHandler={() =>
                        (window.location = `/?access_token=${query.get(
                            'access_token'
            ...
            <div className={css(ss.socialMedia)}>
                <svg
                    onClick={() =>
                        window.open(
                            'https://www.facebook.com/sharer/sharer.php?&u=youtube.com'
                        )
                    }
                    className={css(ss.facebookIcon)}
                ...
                <svg
                    onClick={() =>
                        window.open(
                            'http://twitter.com/share?text=Generate%20Spotify%20Playlists&url=youtube.com'
                        )
                    }
                    className={css(ss.twitterIcon)}
                    viewBox='0 0 512 512'>
